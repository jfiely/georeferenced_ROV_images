...
def main():
    ...
    # Attempt to find a TSV file in the directory
    tsv_filename = None
    ...
    # Process image files
    image_files = [filename for filename in os.listdir(tsv_folder) if filename.endswith((".png", ".heif", ".jpg", ".jpeg"))] # Add more extensions if needed
